...
clusters, silhouette, davies_bouldin, model = cluster_papers(vector_matrix, method='dbscan', eps=0.5, min_samples=5)
...
if hasattr(model, 'cluster_centers_'):
    ...
    top_terms = [[] for _ in range(n_clusters)]  # Empty list if no cluster centers (e.g., for DBSCAN)
